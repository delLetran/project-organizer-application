...
// export const collaboratorReducer = (state=null, action) => {
//   // {username: action.payload.username,
//   // project_id: action.payload.project_id}
  
//   switch (action.type) {
//     case 'GETCOLLABORATORLIST_SUCCESS':
//       return updateObject(state, {
//         collaborators: action.payload.collaborators
//         })
//     case 'GETCOLLABORATORLIST_FAIL':
//       return updateObject(state, {
...
//             ...project, 
//             collaborators: [...state.collaborators, action.payload.collaborator]
//           } : project
//         )
//       }
