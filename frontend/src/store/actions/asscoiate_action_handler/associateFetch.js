...
async function handelRemoveProjectCollaborator(user, project_id, dispatch) {
  ...
  response.ok ?
    dispatch(removeProjectCollaboratorSuccess(user, project_id, json))
  : dispatch(removeProjectCollaboratorFail(user, project_id))
}
